...
define('views/crianca/crianca',['exports', 'aurelia-fetch-client', 'aurelia-framework', 'aurelia-router', 'api/services/criancaService'], function (exports, _aureliaFetchClient, _aureliaFramework, _aureliaRouter, _criancaService) {
  ...
  var Crianca = exports.Crianca = (_dec = (0, _aureliaFramework.inject)(_aureliaRouter.Router, _aureliaFramework.Aurelia, _criancaService.criancaService), _dec(_class = function () {
    ...
    Crianca.prototype.resetForm = function resetForm() {
...
define('views/crianca/listCrianca',['exports', 'aurelia-framework', 'aurelia-event-aggregator', 'aurelia-router', 'api/services/criancaService', 'aurelia-dialog', 'views/modal/modal'], function (exports, _aureliaFramework, _aureliaEventAggregator, _aureliaRouter, _criancaService, _aureliaDialog, _modal) {
  'use strict';
  ...
  var listCrianca = exports.listCrianca = (_dec = (0, _aureliaFramework.inject)(_aureliaRouter.Router, _aureliaFramework.Aurelia, _criancaService.criancaService, _aureliaDialog.DialogService, _aureliaEventAggregator.EventAggregator), _dec(_class = function () {
    function listCrianca(Router, Aurelia, criancaService, DialogService, EventAggregator) {
    ...
    listCrianca.prototype.pesquisa = function pesquisa() {
      ...
      this.criancaService.listarCriancas().then(function (data) {
        if (data.erro == true) {
    ...
    listCrianca.prototype.searchChild = function searchChild() {
      ...
      this.criancaService.searchChild(this.search).then(function (data) {
        if (data.erro == true) {
          _this3.visibilityAlert = 'visible';
          _this3.statusAlert = 'danger';
          _this3.mensagemAlert = data.mensagem;
    ...
    listCrianca.prototype.excluir = function excluir(id, nome) {
      ...
      this.dialogService.open({ viewModel: _modal.Prompt, model: { "tipo": "excluir", "nome": this.nome } }).whenClosed(function (response) {
        if (!response.wasCancelled) {
          _this4.criancaService.excluirCrianca(_this4.id).then(function (data) {
            if (data.erro == true) {
              alert(data.error);
            } else {
...
define('views/home/home',['exports', 'aurelia-framework', 'api/services/criancaService'], function (exports, _aureliaFramework, _criancaService) {
  'use strict';
  ...
  var Home = exports.Home = (_dec = (0, _aureliaFramework.inject)(_criancaService.criancaService), _dec(_class = function () {
    function Home(criancaService) {
    ...
    Home.prototype.countCrianca = function countCrianca() {
      ...
      this.criancaService.countCrianca().then(function (data) {
        if (data.erro == true) {
          _this.visibilityAlert = 'visible';
          _this.statusAlert = 'danger';
          _this.mensagemAlert = data.mensagem;
        } else {
          _this.numberCrianca = data.value;
        }
      });
    };
...
define('views/home/util/homeUtil',['exports', 'aurelia-framework', 'api/services/criancaService'], function (exports, _aureliaFramework, _criancaService) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.homeUtil = undefined;
  ...
  var homeUtil = exports.homeUtil = (_dec = (0, _aureliaFramework.inject)(_criancaService.criancaService), _dec(_class = function () {
    function homeUtil(criancaService) {
      _classCallCheck(this, homeUtil);

      this.criancaService = criancaService;
    }

    homeUtil.prototype.countCrianca = function countCrianca() {

      return this.criancaService.countCrianca().then(function (response) {
        if (data.erro == true) {
          return { error: true, value: data.mensagem };
        } else {
          return { error: false, value: data.value };
        }
      });
    };
...
define('text!app.html', ['module'], function(module) { module.exports = "<template><require from=\"bootstrap/css/bootstrap.css\"></require><require from=\"styles/app.css\"></require><require from=\"styles/menu-lateral.css\"></require><require from=\"styles/home.css\"></require><require from=\"styles/modal.css\"></require><require from=\"styles/listCrianca.css\"></require><require from=\"components/menu-lateral.html\"></require><require from=\"components/loading.html\"></require><require from=\"styles/loading.css\"></require><loading class=\"loading\" css=\" display: ${display}\"></loading><nav class=\"navbar navbar-expand-lg navbar-light\" style=\"background-color:#6495ed\"><a class=\"navbar-brand mb-0 h1 text-white font-weight-bold\" href=\"#\">Elaine Kids</a> <button class=\"navbar-toggler\" type=\"button\" data-toggle=\"collapse\" data-target=\"#navbarSupportedContent\" aria-controls=\"navbarSupportedContent\" aria-expanded=\"false\" aria-label=\"Toggle navigation\"><span class=\"navbar-toggler-icon\"></span></button><div class=\"collapse navbar-collapse\" id=\"navbarSupportedContent\"><ul class=\"navbar-nav mr-auto\"></ul><div class=\"btn-group\"><button class=\"btn btn-outline-light\" type=\"button\">Administrador</button> <button type=\"button\" class=\"btn btn-outline-light dropdown-toggle dropdown-toggle-split\" data-toggle=\"dropdown\" aria-haspopup=\"true\" aria-expanded=\"false\"><span class=\"sr-only\">Toggle Dropdown</span></button><div class=\"dropdown-menu dropdown-menu-right\" aria-labelledby=\"dropdownMenuButton\"><a class=\"dropdown-item\" href=\"#\">Meus Dados</a> <a class=\"dropdown-item\" click.delegate=\"clickSair()\">Sair</a></div></div></div></nav><div class=\"container-fluid\"><div class=\"row\"><div class=\"col-sm-1 col-menulateral\" id=\"menu-laretal\"><menu-lateral class=\"menu-lateral\"></menu-lateral></div><div class=\"col-sm-11\" id=\"conteudo\"><div class=\"row justify-content-center\"><router-view class=\"col-sm-11\"></router-view></div></div></div></div></template>"; });
...
define('text!components/cabecalho.html', ['module'], function(module) { module.exports = "<template><div class=\"dropdown\"><button class=\"btn btn-secondary dropdown-toggle\" type=\"button\" id=\"dropdownMenuButton\" data-toggle=\"dropdown\" aria-haspopup=\"true\" aria-expanded=\"false\">Dropdown button</button><div class=\"dropdown-menu\" aria-labelledby=\"dropdownMenuButton\"><a class=\"dropdown-item\" href=\"#\">Action</a> <a class=\"dropdown-item\" href=\"#\">Another action</a> <a class=\"dropdown-item\" href=\"#\">Something else here</a></div></div></template>"; });
...
define('text!views/home/home.html', ['module'], function(module) { module.exports = "<template><div class=\"row margin-row\"><div class=\"col-sm-3\"><div class=\"card text-center\"><div class=\"card-body\"><h5 class=\"card-title\">Crianças Cadastradas</h5><h2 class=\"card-title\">${numberCrianca}</h2></div></div></div></div></template>"; });
